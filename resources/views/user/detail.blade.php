...
@section('content')
    <div class="container-fluid py-5">
        ...
        <div class="body">
                ...
                @else
                    @foreach ($getData as $getDatas)
                        <div class="col-auto">
                            ...
                            <br>
                            <h1 style="font-size: 30px" class="text-center roboto-bold">Personal Profile</h1>
                        </div>
                    @endforeach
                @endif
            ...
            <div class="deks d-flex justify-content-between align-items-start" style="padding-right: 15em;padding-left: 15em;">
                <div class="deskripsi">
                    @if($getData->isEmpty())
                    <p class="text-start" style="width: 50em">data belum ada</p>
                    @else
                    <p class="text-start" style="width: 50em">{{$data->deskripsi}}</p>
                    @endif
